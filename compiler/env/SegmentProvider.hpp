...
public:
   ...
   virtual void setCollectRegionMemoryLog() {};   // called to set a segment provider to enable region log collection
   ...
   virtual void segmentProviderRegionMemoryLogListInsert(RegionMemoryLog *regionMemoryLog) {};
   virtual void segmentProviderRegionMemoryLogListRemove(RegionMemoryLog *regionMemoryLog) {};
