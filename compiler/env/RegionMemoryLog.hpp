 ...
 *******************************************************************************/
#ifndef OMR_REGION_MEMORY_LOG_HPP
#define OMR_REGION_MEMORY_LOG_HPP
...
class RegionMemoryLog
   {
public:
   // Constructor for regionMemoryLog to keep the log of each region object
   RegionMemoryLog(int startTime, size_t startBytesAllocated, bool isStack);
   ~RegionMemoryLog() {};
   static void regionMemoryLogListInsert(RegionMemoryLog **head, RegionMemoryLog **tail, RegionMemoryLog *target);
   static void regionMemoryLogListRemove(RegionMemoryLog **head, RegionMemoryLog **tail, RegionMemoryLog *target);
   static void printRegionMemoryLogList(RegionMemoryLog *head, TR::FILE *file);
   ...
   RegionMemoryLog *_prev = NULL;
   RegionMemoryLog *_next = NULL;

private:
   void putOffset(TR::FILE *file, char *line);
   void printRegionMemoryLog(TR::FILE *file);
